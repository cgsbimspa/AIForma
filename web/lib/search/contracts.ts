...
export type SearchHit = { scope?: DataScope; key: string; id: string; name: string; type: "folders" | "items"; project: string; projectId: string; path: string; webUrl?: string; version?: number; versionId?: string; matches: SearchMatch[]; contentStatus?: string; endpoint: string; fetchedAt: string };
...
export type SearchBatch = { kind: "search"; stage: SearchStage; terms: SearchTerms; hits: SearchHit[]; issues: SearchIssue[]; warnings: string[]; stats: SearchStats; pending: number; cursor: string | null; done: boolean; startedAt: string };
export type ListingTask = { kind: "list"; folderIds?: string[]; query: DataQuery; path: string; project: string };
export type FileTask = { kind: "file"; folderIds?: string[]; hubId: string; projectId: string; project: string; entry: Entry; path: string; endpoint: string; fetchedAt: string; nameHit: boolean };
