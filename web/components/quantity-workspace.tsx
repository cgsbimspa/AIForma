...
function QuantityDesk(props:Parameters<typeof LegacyQuantityDesk>[0]) {
 return props.configuration.specialtyCode==='structure'?<QuantityModelDesk project={props.project} projectName={props.projectName} configuration={props.configuration} openConfiguration={props.openConfiguration} onSave={props.onSave}/>:<LegacyQuantityDesk {...props}/>;
}
