...
function QuantityDesk(props:Parameters<typeof LegacyQuantityDesk>[0]) {
 return ['structure','mep'].includes(props.configuration.specialtyCode)?<QuantityModelDesk project={props.project} projectName={props.projectName} configuration={props.configuration} openConfiguration={props.openConfiguration} onSave={props.onSave}/>:<LegacyQuantityDesk {...props}/>;
}
