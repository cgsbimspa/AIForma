...
function BimModelSession({project,source}:{project:QuantityProject;source:QuantitySource}){
  ...
  const [catalog,setCatalog]=useState<BimCatalog|null>(null),[selectionCount,setSelectionCount]=useState(0),[filteredCount,setFilteredCount]=useState(0),[filterActive,setFilterActive]=useState(false),[turns,setTurns]=useState<Turn[]>([]),[question,setQuestion]=useState(''),[busy,setBusy]=useState(false);
