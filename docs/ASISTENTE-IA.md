...
Máximo 25 MB por original, 1000 páginas PDF/diapositivas PPTX, 2 millones de caracteres y 75 segundos por extracción aislada. OCR hasta 12 imágenes/páginas y 55 segundos por documento; cualquier página u objeto pendiente produce cobertura parcial explícita. Límites de imágenes: 40 millones de píxeles de entrada y hasta 2600 × 3500 para OCR. ZIP: hasta 10.000 entradas y 100 MB descomprimidos antes de extraer. No se truncan contenidos silenciosamente. La continuación de búsqueda recorre archivos pendientes; no reanuda las páginas OCR omitidas dentro de un archivo. Para esos casos debe proporcionarse un PDF dividido o un alcance de menor tamaño.
