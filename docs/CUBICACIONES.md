...
La clasificación Metalcon también consulta el nombre de elemento publicado por Autodesk: el caso real Metalcon C tiene tipo 60CA085 y Sub Especialidad Cerchas. La asociación conserva el campo y nombre usados como evidencia; no deduce acero por un código de perfil desconocido.
