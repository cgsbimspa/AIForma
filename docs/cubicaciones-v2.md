...
Cada lectura se vincula a proyecto, archivo, versión, derivado y GUID de vista verificados por el servidor. Solo se leen propietarios de geometría de esa vista; se excluyen nodos padre sin geometría para evitar doble conteo. Especialidad publicada tiene prioridad (normalización de mayúsculas y acentos). Cuando corresponde, se conservan las asociaciones de Sub Especialidad a Hormigón explícitamente definidas previamente por el usuario: muros, losas, fundaciones, vigas, pilares y emplantillados. Se registra la regla y el texto original; no se presenta esa asociación como un parámetro publicado. Rebar y Cubierta quedan excluidos del hormigón. Las categorías usan equivalencias explícitas Revit inglés/español, admitiendo el prefijo «Revit» que aparece en la publicación real. No se deduce material, categoría o especialidad de un LLM.
